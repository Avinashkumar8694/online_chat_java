        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                    <h1 data-scroll-reveal="enter from the bottom after 0.1s"><strong>About CHAT SYSTEM : </strong></h1>
                    <p data-scroll-reveal="enter from the bottom after 0.2s">
                        The addition of a website chat system to your website can be a very effective tool for helping you to engage with visitors, but there are are many options available,
                        making it difficult to differentiate and select the best solution.
                    </p>
                    <p data-scroll-reveal="enter from the bottom after 0.4s">
                        It is free Online Chatting System that provides the easiest way for ONLINE Chatting for anyone.
                        With security System which give you a protection from Hacking.
                ...
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                    ...
                    <h1 data-scroll-reveal="enter from the bottom after 0.1s"><strong>Testimonials : </strong></h1>



                    <div class="testimonial" data-scroll-reveal="enter from the bottom after 0.2s">
                       Customisable look and feel, allowing you to make sure the chat window fits with your websites dessign perfectly.
                    </div>


                    <div class="testimonial-name" data-scroll-reveal="enter from the bottom after 0.3s">
                        <h4>CHAT SYSTEM</h4>
                    </div>
                    <br />
                    <div class="testimonial" data-scroll-reveal="enter from the bottom after 0.4s">
                       Automatic messages, proactively enticing visitors to speak to you depending on location in your website.
                    </div>


                    <div class="testimonial-name" data-scroll-reveal="enter from the bottom after 0.4s">
                        <h4>CHAT SYSTEM</h4>
                    </div>
                </div>
            </div>
